      ...
      _createClass(Child, [{
        ...
        value: function componentWillMount() {
          this.context[_ThemeProvider.CHANNEL](function (theme) {
            (0, _expect2.default)(theme).toEqual(Object.assign({}, outerTheme, innerTheme));
            done();
          });
        }
      }, {
  ...
  it('should merge its theme with multiple outer themes', function (done) {
    ...
    var Child = function (_React$Component2) {
      ...
      _createClass(Child, [{
        ...
        value: function componentWillMount() {
          this.context[_ThemeProvider.CHANNEL](function (theme) {
            (0, _expect2.default)(theme).toEqual(Object.assign({}, outerestTheme, outerTheme, innerTheme));
            done();
          });
        }
      }, {
